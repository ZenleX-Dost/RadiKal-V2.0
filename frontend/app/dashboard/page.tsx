          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 animate-slide-up border-2 border-purple-200 dark:border-purple-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                <p className="text-xs font-semibold text-purple-700 dark:text-purple-300 uppercase mb-1">XAI Methods</p>
                <p className="text-3xl font-bold text-purple-900 dark:text-purple-200">{explanationResult.explanations.length}</p>
              </div>
